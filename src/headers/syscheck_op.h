...
/**
 * @brief Parses c_sum string.
 *
 * @param [out] sum
 * @param [in] c_sum
 * @param [in] w_sum
 * @retval 0 on success.
 * @retval 1 when c_sum denotes a deleted file.
 * @retval -1 on failure.
 */
int sk_decode_sum(sk_sum_t *sum, char *c_sum, char *w_sum);

/**
 * @brief Parses fields changes and date_alert only provide for wazuh_db.
 *
 * @param [out] sum
 * @param [in] c_sum
 * @retval 0 on success.
...
/**
 * @brief Fills an event with specific data.
 *
...
/**
 * @brief Deletes from path to parent all empty folders.
 *
...
/**
 * @brief Deletes path file and all empty folders above.
 *
 * @param path The path from which to delete.
 * @retval 0 on success.
 * @retval -1 on failure.
...
/**
 * @brief Changes in Windows paths all slashes for backslashes for compatibility.
 *
 * @param [in, out] path The path of the file to be normalized.
 */
 ...
 * @retval The user name on success.
 ...
 * @retval The group name on success.
 * @retval An empty string on failure.
 */
 ...
 * @retval The bit mask of the file attributes on success.
 * @retval 0 on failure
 */
 ...
 * @retval 0 on success.
 * @retval The error code on failure.
 * @retval -2 if ACE could not be obtained.
 */
...
/**
 * @brief Copies ACE information into buffer.
 *
 ...
 * @retval the number of bytes written into perm on success.
 * @retval 0 on failure
 */
 ...
 *
 * @pre str is assumed to be a 256-byte or longer string.
 */
 ...
 *
 * @param [out] str Buffer to be filled with the permissions.
 * @param [in] str_size The size of the str buffer.
 * @param [in] raw_perm A raw string with the permissions.
 * @param [in] seq 1 to indicate that permissions changed in the buffer.
 * @param [out] perm_array The cJSON object to be filled with the permissions.
 * @retval 1 if cJSON object was filled.
 * @retval Written bytes into str buffer otherwise
 */
 ...
 *
 * @param attributes A bit mask of the attributes.
